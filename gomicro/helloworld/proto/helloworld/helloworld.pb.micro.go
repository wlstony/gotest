...
func (c *helloworldService) Stream(ctx context.Context, in *StreamingRequest, opts ...client.CallOption) (Helloworld_StreamService, error) {
	req := c.c.NewRequest(c.name, "Helloworld.Stream", &StreamingRequest{})
...
func (x *helloworldServiceStream) Recv() (*StreamingResponse, error) {
...
func (c *helloworldService) PingPong(ctx context.Context, opts ...client.CallOption) (Helloworld_PingPongService, error) {
	req := c.c.NewRequest(c.name, "Helloworld.PingPong", &Ping{})
	stream, err := c.c.Stream(ctx, req, opts...)
	if err != nil {
		return nil, err
	}
	return &helloworldServicePingPong{stream}, nil
}
...
type helloworldServicePingPong struct {
	stream client.Stream
}

func (x *helloworldServicePingPong) Close() error {
	return x.stream.Close()
}

func (x *helloworldServicePingPong) Context() context.Context {
	return x.stream.Context()
}

func (x *helloworldServicePingPong) SendMsg(m interface{}) error {
	return x.stream.Send(m)
}

func (x *helloworldServicePingPong) RecvMsg(m interface{}) error {
	return x.stream.Recv(m)
}

func (x *helloworldServicePingPong) Send(m *Ping) error {
	return x.stream.Send(m)
}

func (x *helloworldServicePingPong) Recv() (*Pong, error) {
	m := new(Pong)
	err := x.stream.Recv(m)
	if err != nil {
		return nil, err
...
func (x *helloworldStreamStream) Send(m *StreamingResponse) error {
	return x.stream.Send(m)
}

func (h *helloworldHandler) PingPong(ctx context.Context, stream server.Stream) error {
	return h.HelloworldHandler.PingPong(ctx, &helloworldPingPongStream{stream})
}
...
type helloworldPingPongStream struct {
	stream server.Stream
}

func (x *helloworldPingPongStream) Close() error {
	return x.stream.Close()
}

func (x *helloworldPingPongStream) Context() context.Context {
	return x.stream.Context()
}

func (x *helloworldPingPongStream) SendMsg(m interface{}) error {
	return x.stream.Send(m)
}

func (x *helloworldPingPongStream) RecvMsg(m interface{}) error {
	return x.stream.Recv(m)
}

func (x *helloworldPingPongStream) Send(m *Pong) error {
	return x.stream.Send(m)
}

func (x *helloworldPingPongStream) Recv() (*Ping, error) {
	m := new(Ping)
